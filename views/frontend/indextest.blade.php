...
<div class="" style="display:none;">
		...
		<div id="a" itemscope itemtype="http://data-vocabulary.org/Breadcrumb" itemref="b">
		  <a href="http://www.maisonbest.com.tw/news" itemprop="url">
		    <span itemprop="title">地產動態</span>
		  </a> ›
		</div>
		<div id="b" itemscope itemtype="http://data-vocabulary.org/Breadcrumb" itemprop="child" itemref="c">
		  <a href="http://www.maisonbest.com.tw/cases" itemprop="url">
		    <span itemprop="title">新案訊息</span>
		  </a> ›
		</div>
		<div id="c" itemscope itemtype="http://data-vocabulary.org/Breadcrumb" itemprop="child">
		  <a href="http://www.maisonbest.com.tw/decos" itemprop="url">
		    <span itemprop="title">生活美學</span>
		  </a>
		</div>
</div>
        ...
        <div class="flex">
            <div class="flexslider fs1">
                <ul class="slides">
										<li>
												<div class="youtube">
														<iframe src="https://www.youtube.com/embed/4qSw5zdEgtk" frameborder="0" allowfullscreen></iframe>
...
<script type="application/ld+json">
{
   ...
   "@type": "WebSite",
   "url": "http://www.maisonbest.com.tw/",
   "potentialAction": {
     "@type": "SearchAction",
     "target": "http://www.maisonbest.com.tw/search?name={search_term_string}",
